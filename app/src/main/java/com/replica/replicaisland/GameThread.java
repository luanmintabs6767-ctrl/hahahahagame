            ...
            if (mGameRoot != null) {
                ...
                if (timeDelta > 12) {
                    ...
                    if (mProfileTime > PROFILE_REPORT_DELAY * 1000) {
                        ...
                        mProfileTime = 0;
                        mProfileFrames = 0;
// 분모인 averageFrameTime이 0 이하로 떨어져 앱이 터지는 것을 방지하는 방어 코드
                        int safeFrameTime = (int) averageFrameTime;
                        if (safeFrameTime <= 0) {
                            safeFrameTime = 1;
                        }

                        mGameRoot.sSystemRegistry.hudSystem.setFPS(1000 / safeFrameTime);                    }
                }
