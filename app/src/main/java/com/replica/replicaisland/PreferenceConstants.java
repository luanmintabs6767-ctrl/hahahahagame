...
public class PreferenceConstants {
	...
	public static final String PREFERENCE_GO_TO_ENDING = "goToEnding";
	public static final String PREFERENCE_TOTAL_ATTEMPTS = "totalAttempts";
    public static final String PREFERENCE_TEST_PLAY_ENABLED = "enableTestPlay";
